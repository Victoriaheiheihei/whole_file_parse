...
def preprocess_opts(parser):
  ...
  group.add('--vocab_src_file', '-vocab_src_file', required=False, default="", help="if share vocab and need out_vocab")
  group.add('--vocab_tgt_file', '-vocab_tgt_file', required=False, default="", help="if share vocab and need out_vocab")
...
def translate_opts(parser):
    ...
    group.add('--model', '-model', dest='models', metavar='MODEL',
              nargs='+', type=str, default=['/data1/zyhuang/interactive/pretrained_model/pretrained_bert/model_step_4000.pt'],
    ...
    group.add('--decode_extra_length', '-decode_extra_length', type=int, default=1000,
    ...
    group.add('--minimal_relative_prob', '-minimal_relative_prob', type=float, default=0.01,
